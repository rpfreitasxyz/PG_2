...
A taxa livre de risco, no Brasil, é a Selic. Esta é 2.75%, no momento da escrita, em 27 de abril de 2021.

Assim, podemos calcular o retorno esperado do ativo – essa será a taxa de desconto para o DCF.

\begin{align*}
E(R_i) &= R_f + \beta_i(E(R_m)-R_f) \\
E(R_i) &= 2.75 + 0.66 * 7.63 \\
E(R_i) &= 7.7858
\end{align*}

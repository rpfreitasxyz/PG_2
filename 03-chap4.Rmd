...
Assim, realizando a divisão pelo número de ações disponíveis no mercado,[^acoesDisponiveisCPLE] R\$ `r round(VPL_DCF / 2.73655, 2)` é aproximadamente o valor por ação.
...
Caso consideremos um crescimento aos dos anos de 2017-2019 para o lucro líquido, e tomando como base os valores de 2019, em que não existiram situações muito atípicas no radar da empresa, é razoável assumir que em 2022, o lucro líquido será de aproximadamente 3.6 bilhões de reais.
...
A valorização de `r paste(round(100 * P_VP$CPLE3 / med_P_VP, 2), "%", sep = "")` da empresa relativo ao P/VP médio de `r round(med_P_VP, 2)` dos pares demonstra mais um indicador oportuno.

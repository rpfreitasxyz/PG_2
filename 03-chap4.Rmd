...
tabela_sensibilidade_DCF <- crossing(vec_WACC, vec_CAGR_DCF) %>%
  ...
  mutate(resultado_DCF = paste("R$", round(resultado_DCF, 2), sep = "")) %>%
...
tabela_sensibilidade_DDM <- crossing(vec_LL, vec_retorno_esp) %>%
  ...
  mutate(vec_LL = paste("R$", round(vec_LL, 2), " bi", sep = "")) %>%
  mutate(vec_retorno_esp = paste(round(100 * vec_retorno_esp, 2), "%", sep = "")) %>%
  mutate(resultado_DDM = paste("R$", round(resultado_DDM, 2), sep = "")) %>%

...
Relativo ao grupo de outras empresas analisadas, temos um P/L médio de `r round(med_P_L, 2)`. Através desse indicador, é possível considerar que a Copel está valorizada em `r paste(round(100 * P_L$CPLE3 / med_P_L, 2), "%", sep = "")` relativo à média dos pares.

Similarmente, a valorização de `r paste(round(100 * P_VP$CPLE3 / med_P_VP, 2), "%", sep = "")` da empresa relativo ao P/VP médio de `r round(med_P_VP, 2)` dos pares demonstra mais um indicador oportuno, tendo em vista que o indicador de P/VP torna-se mais relevante quanto mais capital intensivo for o setor. **REFERÊNCIA???**
...
É possível ainda tirar outras conclusões, como

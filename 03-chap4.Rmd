...
Tendo esses comentários em mente, para fins desse estudo, considera-se que o FCFF para 2022 – e que servirá de base para as projeções de FCFFs futuros – seja de 1.8 bilhões de reais. Este valor não é tão grande quanto os 5.1 bi dos 9 meses de 2021, entretanto é uma visão de crescimento se comparado a 2020.
...
tabela_sensibilidade_DCF <- crossing(vec_WACC, vec_CAGR_DCF) %>%
  ...
  mutate_at(1:2, function(x) paste(format(round(100 * x, 2), nsmall = 2), "%", sep = "")) %>%
